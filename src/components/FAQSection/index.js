...
const AccordionItemWrapper = ({ children, borderColor="gray.100" }) => {
  return <AccordionItem borderColor={borderColor}>{children}</AccordionItem>
}
...
const FAQSection = () => {
  return (
    <Stack spacing={6}>
      <Accordion>
        <AccordionItemWrapper borderColor="white">
          <Heading as="h4">
