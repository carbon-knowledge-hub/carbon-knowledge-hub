...
<KeyMessage>
A country first needs to build the capabilities and systems to measure, report and verify emissions and then it could promote the development of a voluntary carbon market before transitioning to a compliance scheme. Designing these programs will require policymakers to take account of the impact on the developing economy and the livelihood of low-income households that tend to be most impacted by the pass-through of carbon prices onto everyday purchases. The structure, flexibility mechanisms and price controls implemented may require some customization from country to country.
</KeyMessage>
