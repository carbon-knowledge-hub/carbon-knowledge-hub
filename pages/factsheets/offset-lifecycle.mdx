...
<KeyMessage>
  Carbon offset projects need to go through six key steps: the project must be
  identified and designed; it must then be validated by a registry before the
  project can be undertaken; emissions must then be measured, reported and
  verified before the offset can be issued and traded; and the last stage is
  retirement.
</KeyMessage>
