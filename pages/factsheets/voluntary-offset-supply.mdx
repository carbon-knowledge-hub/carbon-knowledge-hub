...
<KeyMessage>
  The voluntary carbon markets are oversupplied, with offset issuance climbing
  54% on a compound annual basis since 2018. Most have come from nature-based
  solutions, such as the planting of forests, or energy generation projects,
  like wind and solar farms. In terms of geography, the US was an early starter,
  but India, China and Brazil now account for a growing share of offset supply.
  These trends are set to change due to increasingly stringent regulation on the
