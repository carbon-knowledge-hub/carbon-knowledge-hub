export const metaData = {
  title: "Partners",
  description: "Companies and organizations behind the Carbon Centre of Excellence, including Managing Partners (B20 Indonesia, KADIN and BloombergNEF), which have devised and created the initiative, and Contributing and Supporting Partners, which promote carbon markets as a tool for decarbonization.",
}
