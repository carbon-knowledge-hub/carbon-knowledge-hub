export const metaData = {
  ...
  marketType: ["Voluntary markets", "Compliance markets"],
  organizationType: [
    "policy makers",
...
More governments than ever have net-zero targets. By 2022, countries accounting for 90% of global greenhouse-gas output had such a target in place – up from 54% a year earlier. More ambitious climate commitments will need bolder concrete policies to achieve them, and more and more governments are looking to carbon pricing as a way to drive the significant reduction in emissions needed to avoid the most severe consequences of climate change. Policy makers have sought to make polluters pay for each unit of emissions typically through a tax or market-based system.

<KeyMessage>
  Carbon pricing can be an effective policy tool to make polluters pay for their greenhouse-gas emissions. Out of the 60 or so programs around the world, the most common are taxes and emissions-trading programs. Broadly speaking, the former guarantees the carbon price and the latter delivers a guaranteed reduction in emissions. 
</KeyMessage>

## Markets
The most common type of carbon market is a ‘cap-and-trade’ scheme such as the EU Emission Trading System, and a baseline-and-credit scheme such as China’s national program. A cap-and-trade scheme generally works as follows: 
...
Baseline-and-credit schemes are meant to make it less likely than emissions-trading programs that participants simply pass on the cost of compliance and is meant to better protect companies exposed to international competition. Unlike cap-and-trade schemes, emissions targets are moveable as they are based on emissions per unit of production (emission intensity). If a goal were missed in one year, the regulator could reset baselines in future years, creating uncertainty for participants. Another downside is that the baseline is determined in advance, but the actual volume of production and its emission intensity is not known until the end of the period. 
