...
<KeyMessage>
  ...
  and even an effective CO2 tax or market will not alone enable a government to
...
The ultimate goal of a carbon price is to drive polluters to reduce their greenhouse-gas emissions, for example, by decreasing demand for energy or materials, and switching to cleaner fuels. It is therefore meant to be more effective than a traditional regulation on emissions. For example, if a government introduces a performance standard limiting emissions per unit of output, then companies are only spurred to constrain greenhouse-gas output to the standard set. In contrast, carbon pricing incentivizes emission reduction and charges a price for each additional ton not reduced.

A cap-and-trade program is meant to motivate companies to cut their emissions if the cost of that reduction (or abatement) is lower than the carbon price. If it’s higher, then a company would be incentivized to buy a permit. In this way, carbon pricing is meant to be more effective at spurring emissions reduction than simple regulation. 

Indeed, there is evidence that carbon pricing can be effective: for example, companies participating in the EU Emissions Trading System reduced emissions by 36% between 2008 and 2021. The biggest decrease came from the power sector: even though the carbon price was relatively low – at well below €10 ($12) per metric ton for 2013-18 – it was high enough to make it economic for electricity generators to switch from coal to the less carbon-intensive natural gas. As a result, this sector nearly halved emissions from 2008 to 2021. The carbon price in California – home to the biggest carbon market in the US – has been high enough to phase out coal and gas for power generation. The state therefore cut electricity-sector emissions by 41% between 2013 and 2019.

<Image src="impact-1.png" ratio={0} />

This type of switching from coal to gas may only be temporary but carbon pricing is also starting to drive a permanent change to clean technologies. For example, Sweden’s carbon tax, which now has one of the highest prices in the world, has played a significant role in the 80% reduction in residential emissions since it was introduced in 1991, based on a 2018 study produced for the German government. This decrease was principally driven by households and district-heating systems permanently switching away from oil and other fossil fuels to electric technologies and bioenergy.
